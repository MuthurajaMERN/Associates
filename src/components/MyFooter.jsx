...
export const MyFooter = () => {
  return (
    <Footer className="px-4 lg:px-14 max-w-screen-2xl mx-auto bg-blue-600 py-16">
          ...
          <div className="space-y-10 mr-4">
            ...
            >
              <img
                ...
                alt="Imagem do logo"
              />
              {/* <span className="text-white">Ultrafly Associate</span> */}
            </a>
            <div className="text-white">
              <p className="mb-1">Copyright © 2024 Ultrafly ltd.</p>
